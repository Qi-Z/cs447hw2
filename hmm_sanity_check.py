...
if __name__ == "__main__":
    ...
    try:
        ...
        print "CHECK: If debugging your eval implementation, make sure to regenerate out.txt each time you change your HMM code."
        #### Generate tag output using the current version of your code
        ### print "LOG: Tagging test.txt and writing to out.txt..."
        ### myHMM.test('test.txt', 'out.txt')
        ### print "LOG: ... finished tagging."
